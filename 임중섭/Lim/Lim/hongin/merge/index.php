...
<?php 	
  ...
  <!-- container -->
  <div class="container">
	<div class="writing" style = "position : fixed;z-index : 9999;display : block;padding : 0;margin : 0;top : 95%;left:0;"><a href="#" class=""><img src="" alt="writing img" ></a></div>
    <div id="main">
      <div class="box">
        <div class="content">
          <div class="shield">
  ...
  <div class="asidegroup">
	...
	{
		echo '<textarea id="fake'.$idx.'" style="display : none">'.$WorryList[$idx].'</textarea>';
	}
	//$string = "              hello fuck           ";
//	echo '<textarea id="hello">'.trim($string).'</textarea>';
  ...
  <script>
  //var ff = document.getElementById('hello');
