  ...
  <div class="container">
    ...
    <div id="main" class="worry">
      ...
      <div class="box" >
        ...
        <div class="content">
          <div class="shield">
            <pre id="<?php echo $WorryID[$i]; ?>" class="text" onclick="get(this)"><?php echo $WorryList[$i]; $i++;?>
            </pre>
          </div>
        </div>
      </div>
  ...
  $.ajax({
		...
		success: function(result1){
			...
			else if(result1 != null)
			{
				...
				{
					console.log("contents : "+result1[i]);//+" UserUID : "+result1[1][i]+"REplyRef : " +result1[2][i]+"\n");
				}
