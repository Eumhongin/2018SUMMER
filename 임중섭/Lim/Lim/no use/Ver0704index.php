        ...
        <div class="content">
          <div class="shield">
            <form class="" action="write.php" method="post">
              ...
              <div class="text">
                <textarea name="contents" rows="8" cols="80" style="width:100%;"></textarea>

              </div>
			  Share <input type="checkbox" name="IsShare" value='1' checked> <!-- after 24h delete -->
			  Reply <input type="checkbox" name="IsReply" value='1' checked> <!-- reply ok -->
